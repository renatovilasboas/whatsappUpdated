...
const renderImages = (num, style = initStyle) => {
  switch (num) {
    ...
    case 4:
      return (
        <Image
          source={require("../images/image4.jpeg")}
          style={style}
          resizeMode="contain"
        />
      );
    ...
    case 6:
      return (
        <Image
          source={require("../images/image6.jpeg")}
          style={style}
          resizeMode="contain"
        />
      );
    ...
    case 8:
      return (
        <Image
          source={require("../images/image8.jpeg")}
          style={style}
          resizeMode="contain"
        />
      );
    case 9:
      return (
        <Image
          source={require("../images/image9.jpeg")}
          style={style}
          resizeMode="contain"
        />
      );
    case 10:
      return (
        <Image
          source={require("../images/image10.jpeg")}
          style={style}
          resizeMode="contain"
        />
      );
